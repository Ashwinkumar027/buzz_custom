			...
			<div class="flex flex-col gap-1">
    			...
    			{{ __("Phone Number") }}
  				...
  				<div class="relative">
    				<input
      					:id="'phone-' + index"
      					v-model="attendee.mobile"
						placeholder="  Enter phone number"
      					type="tel"
      					class="w-full border border-outline-gray-3 rounded-md px-3 py-2 bg-surface-gray-2 focus:bg-white focus:border-primary transition"
  	  				/>
  				</div>
			</div>
